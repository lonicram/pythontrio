...
tools: Glob, Grep, Read, WebFetch, WebSearch, Bash, mcp__ide__getDiagnostics, Skill, TaskCreate, TaskGet, TaskUpdate, TaskList, ToolSearch
model: opus
color: red
---
...
- **How**: Code patterns, function signatures, or pseudocode
- **Why**: Brief rationale connecting to the bigger picture
...
to file name to order files chronologically. Please keep in mind that output of this
exercise should be concise - it should be 1 min read.
